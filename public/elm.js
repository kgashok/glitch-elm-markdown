...
var _Http_toTask = F2(function(request, maybeProgress)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try
		{
			xhr.open(request.O, request.aT, true);
		}
		catch (e)
		{
...
function _Http_toResponse(xhr)
{
	return {
		aT: xhr.responseURL,
		aO: { aC: xhr.status, k: xhr.statusText },
...
function _Markdown_formatOptions(options)
{
	...
	{
		if (!lang && elm$core$Maybe$isJust(options.Y))
		{
			lang = options.Y.a;
		}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { aG: 'hidden', z: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { aG: 'mozHidden', z: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { aG: 'msHidden', z: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { aG: 'webkitHidden', z: 'webkitvisibilitychange' }
		: { aG: 'hidden', z: 'visibilitychange' };
}
...
var author$project$Main$Model = function (markdown) {
	return {M: markdown};
};
var author$project$Main$RcvSlide = function (a) {
	return {$: 1, a: a};
};
...
var elm$http$Http$expectString = elm$http$Http$expectStringResponse(
	function (response) {
		return elm$core$Result$Ok(response.ax);
	});
...
var elm$http$Http$getString = function (url) {
	return elm$http$Http$request(
		{ax: elm$http$Http$emptyBody, L: elm$http$Http$expectString, I: _List_Nil, O: 'GET', T: elm$core$Maybe$Nothing, aT: url, U: false});
};
...
var author$project$Main$getSlide = A2(
	elm$http$Http$send,
	author$project$Main$RcvSlide,
	elm$http$Http$getString('text.md'));
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		author$project$Main$Model(elm$core$Maybe$Nothing),
		author$project$Main$getSlide);
};
...
var author$project$Main$update = F2(
	function (msg, model) {
		if (!msg.$) {
			return _Utils_Tuple2(model, author$project$Main$getSlide);
		} else {
			if (!msg.a.$) {
				var resp = msg.a.a;
				return _Utils_Tuple2(
...
var author$project$Main$view = function (model) {
	...
	if (!_n0.$) {
		...
		return elm$html$Html$text('No slides found');
	}
};
...
var author$project$Main$main = elm$browser$Browser$element(
	{aI: author$project$Main$init, aP: author$project$Main$subscriptions, aS: author$project$Main$update, aU: author$project$Main$view});
